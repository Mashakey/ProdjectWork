...
public class MattPaintPageHandler : MonoBehaviour
{
	[SerializeField]
	Button applyButton;
	[SerializeField]
	...
	public void SetPaintFieldActive(Transform paintField)
	{
		...
		Debug.LogError(paintField.Find("Object").gameObject.name);
		frame.GetComponent<RectTransform>().anchoredPosition = new Vector2(0f, 12.5f);
